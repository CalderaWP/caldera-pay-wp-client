...
namespace calderaPayQualpayPaymentGateway\Api;
...
use calderaPayQualpayPaymentGateway\ApiException;
use calderaPayQualpayPaymentGateway\Configuration;
use calderaPayQualpayPaymentGateway\HeaderSelector;
...
class PaymentGatewayApi
{
     ...
     *
     * @param  \calderaPayQualpayPaymentGateway\Model\PGApiTransactionRequest $body Payment Gateway Authorization Request (required)
     *
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \calderaPayQualpayPaymentGateway\Model\PGApiTransactionResponse
     */
     ...
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \calderaPayQualpayPaymentGateway\Model\PGApiTransactionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function authorizationWithHttpInfo($body)
    {
        $returnType = '\calderaPayQualpayPaymentGateway\Model\PGApiTransactionResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\calderaPayQualpayPaymentGateway\Model\PGApiTransactionResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\calderaPayQualpayPaymentGateway\Model\PGApiResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Close batch
     *
     * @param  \calderaPayQualpayPaymentGateway\Model\PGApiBatchCloseRequest $body Payment Gateway Batch Close Request (required)
     *
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \calderaPayQualpayPaymentGateway\Model\PGApiBatchCloseResponse
     */
     ...
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \calderaPayQualpayPaymentGateway\Model\PGApiBatchCloseResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchCloseWithHttpInfo($body)
    {
        $returnType = '\calderaPayQualpayPaymentGateway\Model\PGApiBatchCloseResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\calderaPayQualpayPaymentGateway\Model\PGApiBatchCloseResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \calderaPayQualpayPaymentGateway\Model\PGApiCaptureRequest $body Payment Gateway Capture Request (required)
     *
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \calderaPayQualpayPaymentGateway\Model\PGApiCaptureResponse
     */
     ...
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \calderaPayQualpayPaymentGateway\Model\PGApiCaptureResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function captureWithHttpInfo($pg_id_orig, $body)
    {
        $returnType = '\calderaPayQualpayPaymentGateway\Model\PGApiCaptureResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\calderaPayQualpayPaymentGateway\Model\PGApiCaptureResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \calderaPayQualpayPaymentGateway\Model\PGApiTransactionRequest $body Payment Gateway Credit Request (required)
     *
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \calderaPayQualpayPaymentGateway\Model\PGApiTransactionResponse
     ...
     *
     * @param  \calderaPayQualpayPaymentGateway\Model\PGApiTransactionRequest $body Payment Gateway Force Request (required)
     *
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \calderaPayQualpayPaymentGateway\Model\PGApiTransactionResponse
     ...
     *
     * @param  string $pg_id_orig pgIdOrig (required)
     * @param  \calderaPayQualpayPaymentGateway\Model\PGApiRefundRequest $body Payment Gateway Refund Request (required)
     *
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \calderaPayQualpayPaymentGateway\Model\PGApiRefundResponse
     */
     ...
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \calderaPayQualpayPaymentGateway\Model\PGApiRefundResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function refundWithHttpInfo($pg_id_orig, $body)
    {
        $returnType = '\calderaPayQualpayPaymentGateway\Model\PGApiRefundResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\calderaPayQualpayPaymentGateway\Model\PGApiRefundResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Sale (Auth + Capture)
     *
     * @param  \calderaPayQualpayPaymentGateway\Model\PGApiTransactionRequest $body Payment Gateway Sale Request (required)
     *
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \calderaPayQualpayPaymentGateway\Model\PGApiTransactionResponse
     ...
     * @param  \calderaPayQualpayPaymentGateway\Model\PGApiEmailReceiptRequest $body Payment Gateway Email Receipt Request (required)
     *
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \calderaPayQualpayPaymentGateway\Model\PGApiEmailReceiptResponse
     */
     ...
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \calderaPayQualpayPaymentGateway\Model\PGApiEmailReceiptResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendReceiptWithHttpInfo($pg_id, $body)
    {
        $returnType = '\calderaPayQualpayPaymentGateway\Model\PGApiEmailReceiptResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\calderaPayQualpayPaymentGateway\Model\PGApiEmailReceiptResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Tokenize card
     *
     * @param  \calderaPayQualpayPaymentGateway\Model\PGApiTokenizeRequest $body Payment Gateway Tokenize Request (required)
     *
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \calderaPayQualpayPaymentGateway\Model\PGApiTokenizeResponse
     */
     ...
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \calderaPayQualpayPaymentGateway\Model\PGApiTokenizeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function tokenizeWithHttpInfo($body)
    {
        $returnType = '\calderaPayQualpayPaymentGateway\Model\PGApiTokenizeResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\calderaPayQualpayPaymentGateway\Model\PGApiTokenizeResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Verify Card
     *
     * @param  \calderaPayQualpayPaymentGateway\Model\PGApiVerifyRequest $body Payment Gateway Card Verify Request (required)
     *
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \calderaPayQualpayPaymentGateway\Model\PGApiVerifyResponse
     */
     ...
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \calderaPayQualpayPaymentGateway\Model\PGApiVerifyResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function verifyWithHttpInfo($body)
    {
        $returnType = '\calderaPayQualpayPaymentGateway\Model\PGApiVerifyResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\calderaPayQualpayPaymentGateway\Model\PGApiVerifyResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $pg_id_orig pgIdOrig (required)
     * @param  \calderaPayQualpayPaymentGateway\Model\PGApiVoidRequest $body Payment Gateway Void Request (required)
     *
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \calderaPayQualpayPaymentGateway\Model\PGApiVoidResponse
     */
     ...
     * @throws \calderaPayQualpayPaymentGateway\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \calderaPayQualpayPaymentGateway\Model\PGApiVoidResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function voidWithHttpInfo($pg_id_orig, $body)
    {
        $returnType = '\calderaPayQualpayPaymentGateway\Model\PGApiVoidResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\calderaPayQualpayPaymentGateway\Model\PGApiVoidResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
