...
/**
 * PGApiBatchCloseResponse Class Doc Comment
 *
 * @category Class
 * @package  calderaPayQualpayPaymentGateway
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PGApiBatchCloseResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PGApiBatchCloseResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['batch_info'] = isset($data['batch_info']) ? $data['batch_info'] : null;
    }
     ...
     * Sets batch_info
     *
     * @param string $batch_info <strong>Format: </strong>Variable length<br><strong>Description: </strong>JSON array of JSON objects containing the batch close results by currency and location.
     *
     * @return $this
     */
