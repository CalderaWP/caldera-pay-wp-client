...
class ApiKey implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['security_key'] = isset($data['security_key']) ? $data['security_key'] : null;
    }
    ...
    {
        return $this->container['security_key'];
    }

    /**
     * Sets security_key
     *
     * @param string $security_key The primary security key for the merchant ID requested.
     *
     * @return $this
     */
    public function setSecurityKey($security_key)
    {
        $this->container['security_key'] = $security_key;
