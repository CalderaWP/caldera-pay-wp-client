...
class CheckoutResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'code' => 'int',
        'message' => 'string',
        'data' => '\calderaPayQualpayPlatform\Model\Checkout'
    ];
     ...
     * Gets data
     *
     * @return \calderaPayQualpayPlatform\Model\Checkout
     */
     ...
     * Sets data
     *
     * @param \calderaPayQualpayPlatform\Model\Checkout $data If request is successful, this field will contain the response resource. If there are input validation errors i.e, the  code is 2, this field may contain a list of fields that failed the validation.
     *
     * @return $this
     */
