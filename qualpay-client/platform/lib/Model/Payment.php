...
class Payment implements ModelInterface, ArrayAccess
{
     ...
     * Sets card_type
     *
     * @param string $card_type The two character abbreviation for the card type.
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string[] $currency An array of currency codes allowed for the specified card type.
     *
     * @return $this
     */
