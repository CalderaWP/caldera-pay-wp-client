...
/**
 * RotateKeyResponse Class Doc Comment
 *
 * @category Class
 * @package  calderaPayQualpayPlatform
 * @author   Swagger Codegen team
...
class RotateKeyResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RotateKeyResponse';
    ...
    protected static $swaggerTypes = [
        'code' => 'int',
        'message' => 'string',
        'data' => '\calderaPayQualpayPlatform\Model\ApiKey'
    ];
     ...
     * Gets data
     *
     * @return \calderaPayQualpayPlatform\Model\ApiKey
     */
     ...
     * Sets data
     *
     * @param \calderaPayQualpayPlatform\Model\ApiKey $data If request is successful, this field will contain the response resource. If there are input validation errors i.e, the  code is 2, this field may contain a list of fields that failed the validation.
     *
     * @return $this
     */
