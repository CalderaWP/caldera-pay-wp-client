...
class UpdateDraftRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets customer_id
     *
     * @param string $customer_id The Qualpay customer_id associated with this invoice. Customer should be a valid customer in the system.  <br><strong>Maximum Length: </strong>32
     *
     * @return $this
     */
     ...
     * Sets from_contact
     *
     * @param \calderaPayQualpayPlatform\Model\Contact $from_contact The merchant business contact information. This field is required to send the invoice.
     *
     * @return $this
     */
     ...
     *
     * @param \calderaPayQualpayPlatform\Model\Contact $billing_contact The customer contact information. This field is required to send the invoice.
     *
     * @return $this
     */
     ...
     *
     * @param \calderaPayQualpayPlatform\Model\CheckoutSettings $checkout_settings Invoice checkout page specific settings. from the Invoice Settings page.
     *
     * @return $this
     */
